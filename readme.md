...
Desktop GUI (`app/`, UCI-sidecar над цим же Python-рушієм) тепер має
кнопки на все: колір, складність, нова партія/скасувати/здатись,
режим спостереження за самогрою рушія, і запуск одного циклу
тренування прямо з інтерфейсу. Деталі протоколу, що саме перевірено
й відома межа (немає hot-reload моделі після тренування) —
[`docs/tauri-app-uk.md`](docs/tauri-app-uk.md).
